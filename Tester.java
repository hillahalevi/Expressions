...
//more tests
        ...
        ex = new Pow(new Plus(new Var("x"), new Var("y")), new Num(2));
        if (!ex.differentiate("x").simplifyB().toString().equals("(2.0 * (x + y))")) {
            System.out.println("#94:Error in simplify of:" + ex.differentiate("x").simplifyB());
        }
        ...
        try {
            System.out.println("#114:Error in simplify:" + ex.simplifyB());
        } catch (Exception e2) {
        ...
        try {
            System.out.println("#116 Error in:" + ex.simplifyB());
        } catch (Exception e) {

        }
        ex = new Div("x", "x");
        try {
            System.out.println("#118 Error in:" + ex.evaluate());
        } catch (Exception e) {
        }
